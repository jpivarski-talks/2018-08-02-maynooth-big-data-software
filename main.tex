...
\begin{frame}{Big data ecosystem developed largely independently of ours}
\vspace{0.17 cm}
\includegraphics[width=\linewidth]{separation-2.png}
\end{frame}

\begin{frame}{Don't choose: use both!}
\vspace{0.5 cm}
\large
\begin{columns}[t]
...
\begin{frame}{Distributed processing: Spark}
\Large
\vspace{0.5 cm}
\begin{columns}
...
\vspace{0.5 cm}
\textcolor{darkblue}{\underline{Database-style view of data:}}
