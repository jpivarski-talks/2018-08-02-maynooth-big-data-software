...
\large
\begin{itemize}
\item \textcolor{darkblue}{uproot}, \textcolor{darkblue}{histbook}, \textcolor{darkblue}{vegascope}
\item \textcolor{darkblue}{root\_numpy}, \textcolor{darkblue}{root\_pandas}
\item \textcolor{darkblue}{numpythia}: bindings from Pythia to Numpy
\item \textcolor{darkblue}{pyjet}: bindings from FASTJET to Numpy
\item \textcolor{darkblue}{formulate}: convert between {\tt\normalsize TTree::Draw} syntax and numexpr \mbox{(for histbook)\hspace{-1 cm}}
\item \textcolor{darkblue}{decaylanguage}: express complex $B$ decay chains
\end{itemize}
...
\large
\begin{itemize}
\item \textcolor{darkblue}{hepvector}: LorentzVector operations as Numpy ufuncs
\item \textcolor{darkblue}{root\_ufunc}: use any ROOT function as a Numpy ufunc
\end{itemize}
\end{frame}
